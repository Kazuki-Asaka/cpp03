...
int main(void) {
	...
	DiamondTrap person9("akazuki");
	DiamondTrap person10(person9);
	DiamondTrap person11;

	person11 = person9;
	person9.attack("kazuki");
	person9.takeDamage(100);
	person9.beRapaired(100);
	for (int i = 0; i < 100 ; i++) {
		person9.attack("a");
	}
	person9.highFiveGuys();
	std::cout << "----------------------------"<< std::endl;
	person10.attack("taro");
	person10.beRapaired(10);
	person10.takeDamage(30);
	for (int i = 0; i < 101 ; i++) {
		person10.beRapaired(10);
	}
	person10.highFiveGuys();
	std::cout << "----------------------------"<< std::endl;
	person11.attack("hanako");
	person11.beRapaired(10);
	person11.takeDamage(30);

	person11.takeDamage(30);
	person11.attack("hanako");
	person11.beRapaired(10);
	person11.highFiveGuys();
